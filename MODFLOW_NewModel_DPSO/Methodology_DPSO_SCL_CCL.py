...
if ITERATION == 0:
    ...
    #---    PSO
    α = 0.8   ## ORIGINAL PAPER: 0.8                                                 # Cognitive scaling parameter  # 0.8 # 1.49
    β = 0.8   ## ORIGINAL PAPER: 0.8                                                 # Social scaling parameter     # 0.8 # 1.49                       
    w_min = 0.4                                                 # minimum value for the inertia velocity
    w_max = 0.8                                                 # maximum value for the inertia velocity
