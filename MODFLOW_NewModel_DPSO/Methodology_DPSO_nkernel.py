...
kernel_shape_2_kx = (7,7)
kernel_shape_2_sy = (7,7)
kernel_shape_3_kx = (10,10) #
kernel_shape_3_sy = (10,10) #
kernel_shape_4_kx = (7,7) #
kernel_shape_4_sy = (7,7) #
...
y_init = Run_WEAP_MODFLOW(path_output, str(0), initial_shape_HP, HP, pob.x, n_var_1_kx, n_var_1_sy, n_var_2_kx, n_var_2_sy, n_var_3_kx, 
                          ...
                          kernel_shape_3_kx, kernel_shape_3_sy, kernel_shape_4_kx, kernel_shape_4_sy, active_matriz, path_init_model, path_model, 
